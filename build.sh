...
if [ "$PLATFORM" == "esp32" ];
then
 # MY_COMMAND="cp ${CURPWD}/src/${PROJNAME}.c ${OCFPATH}/iotivity-lite/port/${PLATFORM}/main/main.c"
  #eval ${MY_COMMAND}
...
then
  ...
  MY_COMMAND="cp ${CURPWD}/src/${PROJNAME}.c ${OCFPATH}/iotivity-lite/apps/device_builder_server.c"
  eval ${MY_COMMAND}
  MY_COMMAND="cp ${CURPWD}/src/${PROJNAME}-main.c ${OCFPATH}/iotivity-lite/apps/device_builder_server-main.c"
  eval ${MY_COMMAND}
  MY_COMMAND="cp ${CURPWD}/src/${PROJNAME}-main.cpp ${OCFPATH}/iotivity-lite/apps/device_builder_server-main.cpp"
  eval ${MY_COMMAND}

  MY_COMMAND="cd ${OCFPATH}/iotivity-lite/port/${PLATFORM}/"
  eval ${MY_COMMAND}
  MY_COMMAND="make -f ${CURPWD}/devbuildmake DYNAMIC=1 DEBUG=1 IPV4=1 device_builder_server"
  eval ${MY_COMMAND}
